...
class TestOdesliBot:
    ...
    async def test_extracts_urls(self, bot: OdesliBot):
        ...
        text = (
            ...
            '11 https://dzr.page.link/vmwdqP72fgErpPhM6\n'
            ...
            '17 https://gunnarspardel.bandcamp.com/album/simplicity-in-a-'
            'complex-world\n'
            '18 https://carbonbasedlifeforms.bandcamp.com/track/6equj5\n'
            '19 https://youtu.be/ugYB3VxpivU\n'
            '20 https://spotify.link/a9uvoB7YQyb\n'
            '21 https://open.spotify.com/intl-pt/track/1g6F8wj3IME7EiJ0L0tmzy'
            '?si=e3295c2850eb4a4f'
        )
        ...
        deezer_dzr = urls[2]
        assert deezer_dzr.platform_key == 'deezer'
        assert deezer_dzr.url == 'https://dzr.page.link/vmwdqP72fgErpPhM6'
        deezer_ru = urls[3]
